...
-- Add unique constraint and index for recent_chats
ALTER TABLE recent_chats ADD CONSTRAINT unique_user_room UNIQUE (user_id, room_id);
CREATE INDEX idx_user_last_visited ON recent_chats(user_id, last_visited DESC);
...
-- Trigger for recent_chats updated_at
